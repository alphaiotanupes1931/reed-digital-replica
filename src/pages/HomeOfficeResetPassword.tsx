            ...
            <form onSubmit={handleSubmit} className="border border-border rounded-2xl p-8 space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-border bg-background px-4 py-3 text-sm rounded-xl focus:outline-none focus:border-brand"
                  required
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-brand text-brand-foreground rounded-full py-3 rounded-full text-xs uppercase tracking-widest hover:bg-brand/90 transition-colors disabled:opacity-50"
              >
