    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="border-2 border-primary/30 p-6 max-w-lg mx-auto text-left">
            <p className="text-xs text-primary uppercase tracking-[0.3em] mb-3">
              What Happens Next
            </p>
        ...
        <motion.div
          ...
          className="border border-border rounded-2xl p-8 md:p-12 mb-8"
        >
          <p className="text-xs text-primary uppercase tracking-[0.3em] mb-2">
            A Special Thanks
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {team.map((member, i) => (
              ...
              >
                <div className="w-20 h-20 mb-4 overflow-hidden border border-border">
                  <img
                    src={member.photo}
                    alt={member.name}
                ...
                <p className="text-xs text-primary uppercase tracking-[0.2em] mb-3">
                  {member.title}
                </p>
                <p className="text-sm text-foreground leading-relaxed">
                  {member.description}
      ...
      >
        <div className="bg-[hsl(45,80%,75%)] p-5 shadow-[4px_6px_16px_rgba(0,0,0,0.2)] relative">
          ...
          <p className="text-[10px] text-[hsl(30,20%,25%)] uppercase tracking-[0.2em] mb-2 font-bold">
            📌 Referral Bonus
          </p>
          <p className="text-xs text-[hsl(30,20%,20%)] leading-relaxed mb-2">
          ...
          <p className="text-[10px] text-[hsl(30,20%,30%)]">
            📧{""}
