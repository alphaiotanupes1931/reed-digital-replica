    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-28 pb-20">
        <div className="container max-w-6xl mx-auto px-6">
          ...
          <div className="mt-10 grid grid-cols-2 md:grid-cols-5 border border-border">
            {[
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4 border-2 border-border p-5">
            ...
            <button onClick={notifyAccountant} disabled={linkStatus !=="active"} className="text-[10px] uppercase tracking-widest bg-brand text-brand-foreground rounded-full border-2 border-brand px-4 py-2 hover:bg-brand/90 disabled:opacity-50">
              Notify Accountant
            </button>
          </div>
      ...
      {showAccountantModal && (
        <div className="fixed inset-0 bg-black/60 z-[100] flex items-center justify-center p-6" onClick={() => setShowAccountantModal(false)}>
          <div className="bg-background border border-border rounded-2xl p-8 max-w-md w-full" onClick={e => e.stopPropagation()}>
