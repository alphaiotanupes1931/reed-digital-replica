                  ...
                  {clientInvoices.length === 0 ? (
                    ...
                    <div className="border-t border-border">
                      {clientInvoices.map((inv) => (
                        <div key={inv.id} className="border-b border-border py-4">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="pt-32 pb-8">
          ...
          <div className="flex items-start justify-between gap-4 mt-3">
            ...
            <button onClick={() => setShowClientForm(!showClientForm)} className="text-xs font-mono uppercase tracking-widest border border-foreground/10 rounded-2xl px-4 py-2 hover:bg-foreground hover:text-background transition-colors whitespace-nowrap">
